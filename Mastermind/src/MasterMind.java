...
public class MasterMind {
    ...
    public static void printBoard(char[][] guesses, int[][] hits) {
        ...
        int numColumns = guesses[0].length;
    ...
    public static void main(String[] args) {
       ...
       /*
       String symbolsChar=Config.CODE_SYMBOLS.toString();*/
        ...
        System.out.println("I have a "+ hiddenCode.length + " symbol code using "+ Arrays.toString(symbols)+".");
        ...
        for(int i=0;i<Config.MAX_GUESSES;i++)
        {
            ...
            System.out.println();
            System.out.print("remaining possibilities: "+ updatePossibilities(guess[i], hits[i], possibilities, symbols));
            System.out.println();
            if(hits[i][0]==numPositions)
            {
               System.out.println("Congratulations! You guessed code with only "+ (i+1) + " guesses and "+ hintsCount +" hints!");
               break;
            }
            else 
                flag++;
